...
class _$_Game implements _Game {
  ...
  @override
  String toString() {
    return 'Game(id: $id, name: $name, developers: $developers, cover: $cover, screenshots: $screenshots, rating: $rating, date: $date, genres: $genres, platforms: $platforms, summary: $summary)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _Game &&
            ...
            (identical(other.developers, developers) ||
...
abstract class _Game implements Game {
  factory _Game(
      ...
      required List<String> genres,
      required List<String> platforms,
      required String summary}) = _$_Game;
